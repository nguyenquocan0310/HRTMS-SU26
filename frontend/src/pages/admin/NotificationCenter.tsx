    ...
    <div className={styles.container}>
      ...
      <div className={styles.sectionHeader}>
        <div className={styles.sectionTop}>
          <div>
            <h2 className={styles.sectionTitle}>Trung tâm thông báo</h2>
      ...
      <div className={styles.card}>
        {loading ? (
          <p className={styles.loading}>Đang tải thông báo...</p>
        ) : items.length === 0 ? (
          <div className={styles.empty}>
            <div className={styles.emptyIcon}>
              <FiBell size={24} />
            </div>
            <h3 className={styles.emptyTitle}>Chưa có thông báo</h3>
