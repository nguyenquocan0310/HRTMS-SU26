    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <div>
          ...
          <p>
            Chỉ xem các hoạt động hệ thống; nhật ký không thể chỉnh sửa hoặc
            xóa.
          </p>
        </div>
      ...
      <div className={styles.card}>
        {loading ? (
          ...
          <p className={styles.empty}>Chưa có bản ghi nhật ký phù hợp.</p>
        ) : (
              ...
              <tbody>
                {items.map((item) => (
                  <tr key={item.auditLogId}>
                    ...
                    <td>Người dùng #{item.actorId}</td>
                    <td>{item.action}</td>
                    <td>{item.entityName}</td>
                    <td>Hoàn tất</td>
                    <td>
                      <span>Trước: {formatValue(item.oldValue)}</span>
                      <span>Sau: {formatValue(item.newValue)}</span>
                    </td>
                  </tr>
                ))}
              </tbody>
