...
Errors: `400 INVALID_VENUE_DATA` (TrackType ngoài `Dirt/Turf/Synthetic`, LaneCount
ngoài 2..24) · `409 VENUE_NAME_DUPLICATE`.
...
của một giải đang dùng sân).

### 1.5 Ràng buộc ở Tournament
