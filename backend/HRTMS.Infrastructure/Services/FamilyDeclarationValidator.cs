...
public class FamilyDeclarationValidator : IFamilyDeclarationValidator
{
    ...
    // Role hợp lệ của người thân được khai báo. Từ khi mở khai báo cho cả 4 role
    // (Owner/Jockey/Referee/Doctor), Owner cũng có thể vừa là declarant vừa là related user.
